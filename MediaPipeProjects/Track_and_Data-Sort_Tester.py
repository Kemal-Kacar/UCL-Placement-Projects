...
with mp_pose.Pose(min_detection_confidence=0.8, min_tracking_confidence=0.8) as pose:
    while True:
        ...
        if frameCounter < int(cap.stream.get(cv2.CAP_PROP_FRAME_COUNT)):
            filepath = Path("Frame Collector1/frame" + str(frameCounter) + ".json")
...
# # uncomment this entire section if you want the actual part of the data area!!!!!!!
